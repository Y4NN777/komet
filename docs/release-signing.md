...
Binaries only trust the key they were built with. To rotate:

1. Publish one last release signed with the old key, built with the new
   public key.
2. Switch the secret and variable to the new key for the following releases.
