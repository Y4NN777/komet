...
//!
//! Usage:
//!   cargo run -p komet-rpc --example rpc_probe -- ws://127.0.0.1:27801 LocalDevice '{}'
//!   cargo run -p komet-rpc --example rpc_probe -- ws://127.0.0.1:27801 WatchSessions '{}' --stream 3

use komet_rpc::connect_ws;
